...
export class FooterControlsComponent {
    ...
    selectedLang$: Observable<ITranslation> = this._languageSwitcherService.selectedLang$;

    themes: IThemeModeType[] = this._themeSwitcherService.availableThemes;
    selectedTheme$: Observable<IThemeModeType> = this._themeSwitcherService.selectedTheme$;
