...
export class LoginFormComponent {
    ...
    changeNextButtonState(): void {
        this.nextButtonEnabled = Boolean(this.loginForm.get("usernameOrEmailAddress")?.value.length !== 0);
    };
    ...
    onSubmitLoginForm(): void {
        const formData: ILoginFormModel = this.loginForm.getRawValue() as ILoginFormModel;
        // next
