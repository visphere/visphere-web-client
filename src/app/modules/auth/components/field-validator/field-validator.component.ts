...
@Component({
    ...
    template: `
        <div *ngIf="checkError()">
            {{ "msph." + i18nPrefix + "Page.formFields." + formControlIdentifier + ".errors." + type | translate }}
        </div>
    `,
})
export class FieldValidatorComponent {
    ...
    checkError(): boolean {
        return this._formHelperService.checkError(this.formGroup, this.formControlIdentifier, this.type);
    };
}
