...
const routes: Routes = [
    { path: "", component: AuthRootComponent, children: [
        ...
        { path: "login", component: AuthLoginPageComponent, title: "authLoginPage" },
        { path: "register", component: AuthRegisterPageComponent, title: "authRegisterPage" },
        { path: "reset-password", component: AuthResetPasswordPageComponent, title: "authResetPasswordPage" },
        { path: "change-password/:token", component: AuthChangePasswordPageComponent, title: "authChangePasswordPage" },
    ]}
];
