...
export class AutoChangeLangService {
    ...
    autoChangeLang(): void {
        this._translateService.onLangChange
            .subscribe(() => this._titleStrategy.updateTitle(this._router.routerState.snapshot));
    };
}

////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

function autoChangeLangInitFactory(autoChangeLangService: AutoChangeLangService): () => void {
