 ...
 *
 *    File name: password-strenght-meter.component.ts
 *    Last modified: 7/11/23, 4:16 PM
...
export class PasswordStrengthMeterComponent extends AbstractReactiveProvider implements OnInit, OnDestroy {
    ...
    private calcPasswordStrength(password: string): void {
        if (!password) {
            ...
            this.currentStrength = this._passwordStrengthMeterService.calcPasswordStrength(password);
        }
    };
}
