...
import { AVAILABLE_TRANSLATIONS, ITranslation } from "~/shared-mod/types/translation.type";
...
export class LanguageSwitcherService {
    ...
    private _selectedLang$: BehaviorSubject<ITranslation> = new BehaviorSubject(this.getTranslation(navigator.language));
    ...
    changeLang(translation: ITranslation): void {
        ...
        this._localStorageService.save(StorageKeyType.SELECTED_LANG, { lang: translation.lang });
    };

    loadLang(): void {
        this._translateService.addLangs(this.getFlattenTranslations());
        const savedLang: { lang: string } | null = this._localStorageService.get(StorageKeyType.SELECTED_LANG);
    ...
    private changeMetaProperties(loadedLang: string): void {
        ...
        this.updateMetaProperty("twitter:description", "mpsh.metaProperty.description");
    ...
    private updateManifestLangFile(seletedLang: string): void {
        ...
        manifestTagElement.setAttribute("href", `/assets/manifest/${seletedLang}/pwa-manifest.json`);
    };

    private updateProps(translation: ITranslation): void {
        this._translateService.use(translation.lang).subscribe(() => this.changeMetaProperties(translation.lang));
    ...
    get selectedLang$(): Observable<ITranslation> { return this._selectedLang$.asObservable(); };
    get availableLangs(): ITranslation[] { return this._availableLangs; };
}

////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

function languageSwitcherInitFactory(langSwitcher: LanguageSwitcherService): () => void {
