 ...
 *    Last modified: 7/10/23, 11:03 PM
...
export class FormHelperService {
    ...
    checkError(formGroup: FormGroup, formControlName: string, type: string): boolean {
        return this.getOnlyFirstError(formGroup.get(formControlName)!.errors) === type;
    };
