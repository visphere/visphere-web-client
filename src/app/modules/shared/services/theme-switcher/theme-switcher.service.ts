...
import { IThemeModeType, THEME_MODES, ThemeType } from "~/shared-mod/types/theme-mode.type";
...
export class ThemeSwitcherService {
    ...
    private _selectedTheme$: BehaviorSubject<IThemeModeType> = new BehaviorSubject<IThemeModeType>(this._deviceTheme);
    ...
    loadTheme(): void {
        ...
        const savedTheme: { theme: ThemeType } | null = this._localStorageService.get(StorageKeyType.SELECTED_THEME);
        if (savedTheme) {
    ...
    changeTheme(selectedTheme: ThemeType): void {
        ...
        this._localStorageService.save(StorageKeyType.SELECTED_THEME, { theme: selectedTheme });
    ...
    get availableThemes(): IThemeModeType[] { return THEME_MODES; };
    get selectedTheme$(): Observable<IThemeModeType> { return this._selectedTheme$.asObservable(); };
}

////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

function themeSwitcherInitFactory(themeSwitcher: ThemeSwitcherService): () => void {
